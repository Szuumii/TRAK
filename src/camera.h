...
public:
    Camera(int WindowWidth, int WindowHeight, vec3 CameraPos, float Angle_XZ, float Angle_Y, float fovy = 45,
           float nearz = 1.0f, float farz = 1000.0) :
            WindowWidth(WindowWidth), WindowHeight(WindowHeight), CameraPos(CameraPos), Angle_XZ(Angle_XZ),
            Angle_Y(Angle_Y),
