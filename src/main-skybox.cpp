...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/cubemaps/vertex_shader.vs", "shaders/cubemaps/fragment_shader.fs");
    Shader skyboxShader("shaders/skybox/vertex_shader.vs", "shaders/skybox/fragment_shader.fs");
