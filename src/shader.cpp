...
public:
    ...
    static void
    glGenProgramFromFile(const char *programName, const char *vShader, const char *tcShader, const char *teShader,
                         const char *gShader, const char *fShader) {
...
private:
    static GLuint
    glCompileProgramFromFile(const char *vShader, const char *tcShader, const char *teShader, const char *gShader,
                             const char *fShader) {
    ...
    static GLuint glCompileProgram(const char *vShader, const char *tcShader, const char *teShader, const char *gShader,
                                   const char *fShader) {
